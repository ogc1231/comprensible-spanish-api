...
This was generated using my deployed site URL: https://comp-spanish-api-35f1e1574e0f.herokuapp.com
...
User-agent: *
Disallow:
Sitemap: https://comp-spanish-api-35f1e1574e0f.herokuapp.com/sitemap.xml
```
...
The live deployed application can be found deployed on [Heroku](https://comp-spanish-api-35f1e1574e0f.herokuapp.com).
...
- Provide a name (this is commonly the name of the project: comprensible-spanish-api).
...
- From **User Groups**, click **Create New Group**.
	- Suggested Name: `group-comprensible-spanish-api` (group + the project name)
...
- From the **JSON** tab, select the **Import Managed Policy** link.
	...
	- Click **Review Policy**.
	- Suggested Name: `policy-comprensible-spanish-api` (policy + the project name)
	- Provide a description:
		- "Access to S3 Bucket for comprensible-spanish-api static files."
	- Click **Create Policy**.
- From **User Groups**, click your "group-comprensible-spanish-api".
- Click **Attach Policy**.
- Search for the policy you've just created ("policy-comprensible-spanish-api") and select it, then **Attach Policy**.
- From **User Groups**, click **Add User**.
	- Suggested Name: `user-comprensible-spanish-api` (user + the project name)
- For "Select AWS Access Type", select **Programmatic Access**.
- Select the group to add your new user to: `group-comprensible-spanish-api`
...
- From there, click **Add Endpoint**.
	- `https://comp-spanish-api-35f1e1574e0f.herokuapp.com/checkout/wh/`
...
- Select **Other (Custom name)** for the device type.
	- Any custom name, such as "Django" or comprensible-spanish-api
